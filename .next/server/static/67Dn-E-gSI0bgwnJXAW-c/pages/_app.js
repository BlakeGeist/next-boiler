...
// EXTERNAL MODULE: ./helpers/getAbsoluteUrl.js
var getAbsoluteUrl = __webpack_require__("ki/z");
...
// CONCATENATED MODULE: ./helpers/setUserState.js




/* harmony default export */ var setUserState = (async ctx => {
  const {
    apiURL
  } = Object(getAbsoluteUrl["a" /* default */])(ctx.req);
  const {
    token2
  } = external_next_cookies_default()(ctx);
  const getUserResponse = await external_axios_default.a.post(`${apiURL}/api/getUserFromToken`, {
    token: token2
  });
...
// CONCATENATED MODULE: ./helpers/redirectIfNoLanguage.js
/* harmony default export */ var redirectIfNoLanguage = (ctx => {
...
// CONCATENATED MODULE: ./helpers/getPageStrings.js





/* harmony default export */ var getPageStrings = (async ctx => {
...
// CONCATENATED MODULE: ./helpers/getGlobalStrings.js





/* harmony default export */ var getGlobalStrings = (async ctx => {
  if (!app_default.a.apps.length) {
    app_default.a.initializeApp(client_default.a);
  }
