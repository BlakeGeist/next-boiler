...
module.exports = __webpack_require__("6fnw");
...
/* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
  ...
  admin.auth().verifyIdToken(token).then(async user => {
    ...
    userDataCollection.doc(user.uid).get().then(doc => {
      const userData = Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])({}, user, doc.data());
