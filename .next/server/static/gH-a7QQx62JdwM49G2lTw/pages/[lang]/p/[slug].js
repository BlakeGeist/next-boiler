...
module.exports = __webpack_require__("iYTk");
...
/* harmony import */ var _api_helpers_getAbsoluteUrl__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("/qor");
var __jsx = react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement;
...
const Product = ({
  ...
  return __jsx(_layouts_Layout__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"], null, __jsx("div", {
    className: "container"
  }, __jsx("h1", null, product.name), __jsx("div", {
    className: "products-product-description",
...
Product.getInitialProps = async ({
  ...
  const {
    apiURL
  } = Object(_api_helpers_getAbsoluteUrl__WEBPACK_IMPORTED_MODULE_4__["default"])(req);
  const productResp = await axios__WEBPACK_IMPORTED_MODULE_3___default.a.post(`${apiURL}/api/getProductBySlug`, {
    slug: query.slug
  });
...
/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_1__["connect"])(state => state)(Product));
